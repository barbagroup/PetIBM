 ...
 * \param periodic [out] returned 2D array of `PetscBool` indicating the status
 * of periodic BCs.
 *
 ...
 * \param n [in] a 1D array of the numbers of the cells in x, y and z
 * directions. \param loc [in] the desired location of this boundary. \param
 ...
 *        boundary point.
 *
 * \param n [in] a 1D array of numbers of cells in different directions of
 * desired velocity field. \param loc [in] the location of the desired boundary.
 ...
 * \ingroup miscModule
 */
inline PetscErrorCode stretchGrid(const PetscReal &bg, const PetscReal &ed,
                                  const PetscInt &n, const PetscReal &r,
                                  type::RealVec1D &dL)
{
...
inline PetscErrorCode tripleLoops(
    const LoopBound &bound1, const LoopBound &bound2, const LoopBound &bound3,
    const std::function<PetscErrorCode(const PetscInt &, const PetscInt &,
                                       const PetscInt &)> &f)
{
