...
public:
    ...
    SingleBoundaryBase(const type::Mesh &mesh, const type::BCLoc &loc,
                       const type::Field &field, const type::BCType &type,
     ...
     * \param lclVec [in, out] a local Vec with memory allocations for ghost
     * points. \return PetscErrorCode.
     *
 ...
 * \see boundaryModule, petibm::boundary::SingleBoundaryBase,
 ...
 * \return PetscErrorCode.
 * \see boundaryModule, petibm::type::SingleBoundarym
