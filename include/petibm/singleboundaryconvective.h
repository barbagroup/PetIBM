...
protected:
     ...
     *        the location of the boundary and the target field in a staggered
     * grid. \param targetValue [in] The value at time \f$t-1\f$ of the
     * corresponding boundary point. \param dt [in] Time-step size. \param
     * normal [in] Normal of the boundary: \f$+1\f$ represent *PLUS faces, while
     * \f$-1\f$ means *MINUS faces. \param value [in] The value of the boundary
     * condition. \param p [in, out] A petibm::type::GhostPointInfo. \return
     * PetscErrorCode.
     */
    PetscErrorCode (*kernel)(const PetscReal &targetValue, const PetscReal &dt,
