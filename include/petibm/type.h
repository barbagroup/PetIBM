 ...
 * \arg \c \b PetscReal
 * http://www.mcs.anl.gov/petsc/petsc-current/docs/manualpages/Sys/PetscReal.html
 * \arg \c \b PetscBool
 * http://www.mcs.anl.gov/petsc/petsc-current/docs/manualpages/Sys/PetscBool.html
 * \arg \c \b PetscErrorCode
 * http://www.mcs.anl.gov/petsc/petsc-current/docs/manualpages/Sys/PetscErrorCode.html
 * \arg \c \b MatStencil
 * http://www.mcs.anl.gov/petsc/petsc-current/docs/manualpages/Mat/MatStencil.html
 * \arg \c \b Mat
 * http://www.mcs.anl.gov/petsc/petsc-current/docs/manualpages/Mat/Mat.html \arg
 * \c \b Vec
 * http://www.mcs.anl.gov/petsc/petsc-current/docs/manualpages/Vec/Vec.html \arg
 * \c \b KSP
 * http://www.mcs.anl.gov/petsc/petsc-current/docs/manualpages/KSP/KSP.html
 * \ingroup petibm
 */
...
/** \brief a vector of vector pointers to mimic ghosted 2D vectors. \ingroup
 * type */
...
{
    PetscInt
        lclId;  ///< the index in a local velocity vector of this ghost point
    MatStencil targetStencil;  ///< the stencil of point corresponding to this
                               ///< ghost point
    PetscInt targetPackedId;   ///< the index of target point in global packed
                               ///< velocity vector
    PetscReal area;            ///< the flux area of this ghost point
    PetscReal dL;     ///< the distance between this ghost point and target
                      ///< velocity point
