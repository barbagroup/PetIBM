...
# file: runDiffusiveTermTest.py
# author: Olivier Mesnard (mesnardo@gwu.edu)
# brief: Runs the unit-test for the diffusive term in 2d and 3d 
...
def plot_spatial_convergence(file_path, legend, output_file):
  """Plots the relative errors in the diffusive term versus the grid-spacing.
  ...
  pyplot.ylabel('relative error in diffusive term ($L_2$-norm)')
...
def main():
  ...
  plot_spatial_convergence('{}/data/relativeErrors2d.dat'.format(test_directory), 
                           'diffusive term (2d)', 
                           '{}/data/convergenceDiffusiveTerm2d.png'.format(test_directory))
  # 3d cases
  plot_spatial_convergence('{}/data/relativeErrors3d.dat'.format(test_directory), 
                           'diffusive term (3d)', 
                           '{}/data/convergenceDiffusiveTerm3d.png'.format(test_directory))
